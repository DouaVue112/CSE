world_map = {
    ...
    'NORTH MCDONALD': {
        ...
        'DESCRIPTION': "They riped you off. The meal was 10 dollars. "
    ...
    'PEOPLE': {
        'NAME': "People",
        'DESCRIPTION': "You see people. You asked for help. They told you to go south to go to a food max. ",
        'PATHS': {
            'SOUTH': 'FOOD MAX'
        }
    },
    ...
    'FRIENDS HOUSE': {
        'NAME': "Friends House",
        'DESCRIPTION': "Your friend bought a pizza. He told chu to eat. "
...
while True:
    ...
    if current_node == world_map['GHOST'] or current_node == world_map['EAST KFC']:
        exit(0)
